...
class Camera_log_model extends CI_Model
{

    public $table = 'camera_log';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file Camera_log_model.php */
/* Location: ./application/models/Camera_log_model.php */
