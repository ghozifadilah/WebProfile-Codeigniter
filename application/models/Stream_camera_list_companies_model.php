...
class Stream_camera_list_companies_model extends CI_Model
{

    public $table = 'stream_camera_list_companies';
    public $id = '';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
		...
		$this->db->or_like('streamer_id', $q);
		$this->db->or_like('company_id', $q);
		$this->db->or_like('streamer_name', $q);
		$this->db->or_like('ip', $q);
		$this->db->or_like('id_companies', $q);
		$this->db->or_like('company_name', $q);
		$this->db->or_like('adresss', $q);
...
/* End of file Stream_camera_list_companies_model.php */
/* Location: ./application/models/Stream_camera_list_companies_model.php */
