...
class Log_model extends CI_Model
{
    ...
    //record_activity
    function record($activity,$user_id=null)
    {
        $data = [
    ...
    function total_rows($q = NULL) {
        $this->db->like('log_id', $q);
		$this->db->or_like('log_user_id', $q);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2021-06-28 09:39:39 */
/* http://harviacode.com */