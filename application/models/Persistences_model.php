...
class Persistences_model extends CI_Model
{

    public $table = 'persistences';
    public $id = 'id';
    public $order = 'DESC';
...
/* End of file Persistences_model.php */
/* Location: ./application/models/Persistences_model.php */
