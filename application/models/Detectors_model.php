...
class Detectors_model extends CI_Model
{

    public $table = 'detectors';
    public $id = 'id';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
        $this->db->like('id', $q);
		$this->db->or_like('camera_id', $q);
		$this->db->or_like('point_a_x', $q);
		$this->db->or_like('point_a_y', $q);
		$this->db->or_like('point_b_x', $q);
		$this->db->or_like('point_b_y', $q);
		$this->db->or_like('line_order', $q);
		$this->db->from($this->table);
...
/* End of file Detectors_model.php */
/* Location: ./application/models/Detectors_model.php */
